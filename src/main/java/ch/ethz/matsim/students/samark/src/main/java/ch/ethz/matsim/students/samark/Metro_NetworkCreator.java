...
public class Metro_NetworkCreator {
	...
	public static void run() {
		...
		Map<Id<Link>, CustomLinkAttributes> links_withinRadius = Metro_NetworkImpl.findLinksWithinBounds(
				...
				maxMetroRadiusFromCenter, "Metro/Input/Generated_Networks/1_zurich_network_WithinRadius"
		...
		Map<Id<Link>, CustomLinkAttributes> links_mostFrequentInRadiusMainFacilitiesSet = Metro_NetworkImpl.setMainFacilities(originalTransitSchedule, 
						originalNetwork, links_mostFrequentInRadius, "Metro/Input/Generated_Networks/2_zurich_network_MostFrequentInRadius.xml");
		...
		Map<Id<Link>, CustomLinkAttributes> links_MetroTerminalCandidates = Metro_NetworkImpl.findLinksWithinBounds(links_mostFrequentInRadiusMainFacilitiesSet, 
				originalNetwork, zurich_NetworkCenterCoord, minTerminalRadiusFromCenter, maxTerminalRadiusFromCenter, "Metro/Input/Generated_Networks/3_zurich_network_MetroTerminalCandidate.xml"); // find most frequent links
		...
		Network metroNetwork = Metro_NetworkImpl.createMetroNetworkFromCandidates(
				...
				"Metro/Input/Generated_Networks/4_zurich_network_MetroNetwork.xml");
		...
		ArrayList<NetworkRoute> initialMetroRoutes = Metro_NetworkImpl.createInitialRoutes(metroNetwork,
				links_MetroTerminalCandidates, nRoutes, minTerminalDistance, "Metro/Input/Generated_Networks/5_zurich_network_MetroInitialRoutes.xml");
		Network separateRoutesNetwork = Metro_NetworkImpl.networkRoutesToNetwork(initialMetroRoutes, metroNetwork, Sets.newHashSet("pt"), "Metro/Input/Generated_Networks/5_zurich_network_MetroInitialRoutes.xml");
		...
		for(int lineNr=1; lineNr<=nTransitLines; lineNr++) {		
			...
			// Build TransitRoute from stops and NetworkRoute --> and add departures
				...
				String vehicleFileLocation = "Metro/Input/Generated_PT_Files/vehicles.xml";
		...
		tsw.writeFile("Metro/Input/Generated_PT_Files/MetroSchedule.xml");
				
		Network mergedNework = Metro_TransitScheduleImpl.mergeRoutesNetworkToOriginalNetwork(separateRoutesNetwork, originalNetwork, Sets.newHashSet("pt"), "Metro/Input/Generated_Networks/MergedNetwork.xml");
		TransitSchedule mergedTransitSchedule = Metro_TransitScheduleImpl.mergeAndWriteTransitSchedules(metroSchedule, originalTransitSchedule, "Metro/Input/Generated_PT_Files/MergedSchedule.xml");
		Vehicles mergedVehicles = Metro_TransitScheduleImpl.mergeAndWriteVehicles(metroScenario.getVehicles(), originalScenario.getVehicles(), "Metro/Input/Generated_PT_Files/MergedVehicles.xml");
