...
public class OutputTestingImpl {
	...
	public static void createNetworkFromCustomLinks(Map<Id<Link>,CustomLinkAttributes> customLinkMap, Network oldNetwork) {
		...
		networkWriterLinks.write("zurich_1pm/created_input/zurich_network_strongestLinks.xml");
		
		NetworkWriter networkWriterNodes = new NetworkWriter(strongestLinksNetwork);
		networkWriterNodes.write("zurich_1pm/created_input/zurich_network_FacilityCoordNodes.xml");
